...
(function (fns) {
    ...
    */
    fns.enc = function (data, firstKey, secondKey, thirdKey) {
        ...
        if (leng > 0) {
            if (leng < 4) {
                ...
                if (firstKey != null && firstKey != "" && secondKey != null && secondKey != "" && thirdKey != null && thirdKey != "") {
                    ...
                    for (var y = 0; y < secondLength; y++) {
                        tempBt = enc(tempBt, secondKeyBt[y]);
                    }
                    for (var z = 0; z < thirdLength; z++) {
    ...
    */
    fns.dec = function (data, firstKey, secondKey, thirdKey) {
        var leng = data.length;
        var decStr = "";
        var firstKeyBt, secondKeyBt, thirdKeyBt, firstLength, secondLength, thirdLength;
        if (firstKey != null && firstKey != "") {
        ...
        for (var i = 0; i < iterator; i++) {
            ...
            if (firstKey != null && firstKey != "" && secondKey != null && secondKey != "" && thirdKey != null && thirdKey != "") {
                ...
                var x, y, z;
                tempBt = intByte;
                for (var x = thirdLength - 1; x >= 0; x--) {
                    tempBt = dec(tempBt, thirdKeyBt[x]);
                }
                for (var y = secondLength - 1; y >= 0; y--) {
                    tempBt = dec(tempBt, secondKeyBt[y]);
                }
                for (var z = firstLength - 1; z >= 0; z--) {
                ...
                if (firstKey != null && firstKey != "" && secondKey != null && secondKey != "") {
                    ...
                    var x, y, z;
                    tempBt = intByte;
                    for (var x = secondLength - 1; x >= 0; x--) {
                        tempBt = dec(tempBt, secondKeyBt[x]);
                    }
                    for (var y = firstLength - 1; y >= 0; y--) {
